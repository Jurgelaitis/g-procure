 ...
 *
 * REŽIMAS (nuo 2026-09-24). Kiekviena tema turi `rezimas`: ["PI"] - atsakymas
 * remiasi PĮ straipsniais ir galioja perkantiesiems subjektams; ["PI", "VPI"] -
...
;(function (global) {
  ...
  var SALTINIAI = [
    ...
    { id: "S2", tipas: "teises_aktas", kalba: "lt", patikrinta: PATIKRINTA, redakcija: "galiojanti suvestinė redakcija 2026-07-01 - 2026-12-31", galiojaIki: "2026-12-31",
      ...
      pastaba: { lt: "Teisės norma perkantiesiems subjektams (energetika, vandentvarka, transportas, paštas; pvz. LITGRID, Amber Grid). Perkančiosioms organizacijoms taikomas VPĮ - jo atitikmenų šioje bazėje dar nėra.", en: "The statute for contracting entities (energy, water, transport, postal services; e.g. LITGRID, Amber Grid). Contracting authorities are governed by the classic law (VPĮ) - its equivalents are not in this base yet." } },
    { id: "S3", tipas: "perkanciojo_taisykles", organizacija: "litgrid", kalba: "lt", patikrinta: PATIKRINTA, redakcija: "MV aprašas patvirtintas 2024-12-19 įsak. Nr. 24IS-267",
  ...
  var TEMOS = [
    { id: "rasti", zymos: ["cvpis", "paieska"], rezimas: ["PI", "VPI"], organizacijuNuorodos: true,
      q: { lt: "Kaip rasti organizacijos pirkimus CVP IS?", en: "How do I find an organisation's procurements in CVP IS?" },
      a: { lt: "Perkančiųjų organizacijų ir perkančiųjų subjektų pirkimai skelbiami Centrinėje viešųjų pirkimų informacinėje sistemoje (CVP IS, viesiejipirkimai.lt). Neprisijungus veikia „Išplėstinė paieška“ (pirkimo vykdytojo lauke įrašius organizacijos pavadinimą ar jo dalį) ir „Naujausi pirkimai“; prisijungus - paieška organizacijose, skelbimuose ir pirkimų suvestinėje. Tarptautinės vertės pirkimai skelbiami ir TED. Dalis organizacijų savo svetainėse skelbia metinius planuojamų pirkimų sąrašus ir dinaminių pirkimų sistemų (DPS) sąrašus su nuorodomis į CVP IS - žinomų organizacijų nuorodos pateiktos žemiau.",
           en: "Procurements of contracting authorities and contracting entities are published in the Central Public Procurement Information System (CVP IS, viesiejipirkimai.lt). Without logging in you can use “Advanced search” (enter the organisation's name or part of it as the contracting entity) and “Latest procurements”; when logged in - search by organisation, notices and the procurement summary. Above-threshold procurements are also published on TED. Some organisations publish annual planned procurement lists and lists of dynamic purchasing systems (DPS) with links to CVP IS on their websites - links of known organisations are given below." },
      veiksmai: { lt: ["Atidarykite CVP IS išplėstinę paiešką ir pirkimo vykdytojo lauke įrašykite organizacijos pavadinimą (arba naudokite žinomų organizacijų nuorodas žemiau).", "Patikrinkite organizacijos svetainėje, ar skelbiamas metinis pirkimų planas - kada planuojamas jus dominantis pirkimas.", "Užsiprenumeruokite pranešimus pagal BVPŽ kodus (žr. atskirą temą)."],
                 en: ["Open the CVP IS advanced search and enter the organisation's name in the contracting entity field (or use the links of known organisations below).", "Check on the organisation's website whether an annual procurement plan is published - when a procurement of interest is planned.", "Subscribe to notifications by CPV codes (see separate topic)."] },
      saltiniai: [{ id: "S1", cit: { lt: "„Paieškos vykdymas per CVP IS (tiekėjai)“, 2026-05-20, 3-8 skaidrės", en: "“Searching via CVP IS (suppliers)”, 2026-05-20, slides 3-8" } },
                  { id: "S3", cit: { lt: "Litgrid pirkimai / Pirkimai: informacija skelbiama CVP IS; 2026 m. planuojamų vykdyti pirkimų sąrašas (LT/EN); DPS sąrašas (LITGRID pavyzdys)", en: "Litgrid procurement pages: published in CVP IS; 2026 planned procurement list (LT/EN); DPS list (LITGRID example)" } }],
      spraga: { lt: "CVP IS sąrašo adresas su organizacijos filtru turi sistemos generuojamą puslapiavimo parametrą - jei nuoroda nustotų veikti, naudokite išplėstinę paiešką. Kitų organizacijų (ne LITGRID) planų ir taisyklių nuorodos registre dar nepatikrintos.", en: "The CVP IS list URL with the organisation filter contains a system-generated paging parameter - if it stops working, use the advanced search. Plan and rules links of organisations other than LITGRID are not yet verified in the registry." } },

    { id: "bvpz", zymos: ["cvpis", "prenumerata"], rezimas: ["PI", "VPI"],
    ...
    { id: "budai", zymos: ["procedura"], rezimas: ["PI"],
      ...
      spraga: { lt: "Konkretūs derybų etapų žingsniai CVP IS aprašomi pirkimo dokumentuose, ne viešuose šaltiniuose.", en: "The specific steps of negotiations in CVP IS are described in the procurement documents, not in public sources." } },

    { id: "paraiska", zymos: ["procedura"], rezimas: ["PI"],
    ...
    { id: "ebvpd", zymos: ["dokumentai"], rezimas: ["PI"],
      ...
      spraga: { lt: "Pirkimo vykdytojo specifiniai EBVPD reikalavimai viešai neskelbiami - jie pirkimo sąlygose. VPT DUK rašyti VPĮ straipsniais; PĮ atitikmenys - 37 str. 1 d. (pažymos) ir 59 str. 1 d. (taikymas).", en: "Buyer-specific ESPD requirements are not public - they are in the conditions. PPO FAQ cites the classic law; the PĮ equivalents are Art. 37(1) (certificates) and Art. 59(1) (application)." } },

    { id: "klausimas", zymos: ["cvpis", "terminai"], rezimas: ["PI"],
    ...
    { id: "konfidencialumas", zymos: ["dokumentai"], rezimas: ["PI"],
    ...
    { id: "subtiekejai", zymos: ["dokumentai"], rezimas: ["PI"],
      ...
      spraga: { lt: "VPT DUK cituoja VPĮ 88 str.; PĮ atitikmuo - 96 str. Pirkimo vykdytojo formos - tik pirkimo sąlygose.", en: "PPO FAQ cites classic-law Art. 88; the PĮ equivalent is Art. 96. The buyer's forms are only in the conditions." } },

    { id: "pries_pateikiant", zymos: ["patikra"], rezimas: ["PI"],
      ...
      spraga: { lt: "Pirkimo vykdytojo specifiniai reikalavimai (pvz. LITGRID saugaus darbo aprašas, įrangos atitikties pagrindimas, eksploatavimo reglamentai) taikomi tik tada, kai juos nurodo konkretaus pirkimo sąlygos.", en: "Buyer-specific requirements (e.g. LITGRID safety rules, equipment conformity, operation regulations) apply only when the conditions of the specific procurement refer to them." } },

    { id: "klaidos", zymos: ["patikra", "cvpis"], rezimas: ["PI", "VPI"],
      ...
      spraga: { lt: "Nėra VPT statistinio klaidų sąrašo ir pirkimo vykdytojų praktikos apie dažniausiai atmestus pasiūlymus.", en: "There is no PPO statistical list of errors and no buyer practice on the most frequently rejected bids." } },

    { id: "galiojimas_uztikrinimas", zymos: ["dokumentai"], rezimas: ["PI"],
    ...
    { id: "pretenzija", zymos: ["ginčai"], rezimas: ["PI"],
      ...
      spraga: { lt: "Mažos vertės pirkimuose gali būti taikoma pirkimo vykdytojo mažos vertės pirkimų tvarka (pvz. LITGRID MV aprašas) - tikrinkite pirkimo sąlygas.", en: "In low-value procurements the buyer's low-value rules may apply (e.g. the LITGRID low-value rules) - check the conditions." } }
  ];
