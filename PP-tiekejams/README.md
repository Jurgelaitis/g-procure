...
| `cvpis.js` | CVP IS viešų nuorodų šablonai (patikrinti 2026-09-02), resolve, terminai Europe/Vilnius, jungties būsena; pirkėjo ir teisinio režimo atpažinimas iš skelbimo (`atpazinkPirkeja`, `atpazinkRezima`, 2026-09-24; nuo 2026-09-26 - nuorodos į `../shared/skelbimas.js`, kuriuo pildoma ir pirkimo kortelė) |
| `../shared/organizacijos.js` | Pirkimo vykdytojų registras (`GP_ORG`, nuo 2026-09-26 bendras su pirkimo kortele): LITGRID (patikrintos taisyklės, planas), Amber Grid, EPSO-G, Energy cells (tik CVP IS sąrašo nuorodos, taisyklių registre nėra); atpažinimas pagal skelbimo pavadinimą, tikėtinas režimas (galioja skelbimas, ne registras) |
