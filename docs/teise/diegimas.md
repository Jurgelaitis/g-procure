...
| Failas | Paskirtis |
|---|---|
| `PP-teise/index.html` | Stebėsenos puslapis: kompaktiška antraštė su patikimumo eilute, paieška ir filtrai, vaizdai (kas pasikeitė / kas įsigalios / ką peržiūrėti / trūksta duomenų / archyvas), po jais sąrašas kairėje (~35 %) ir pasirinkto įrašo detalės dešinėje (A-G: antraštė ir statusai, pokyčio esmė, kam aktualu, nuo kada taikoma, ką peržiūrėti, pagrindimas ir šaltiniai su pažodine ištrauka, sutraukti rekvizitai); pasirinkimas adrese `#irasas=id`, filtrai adreso parametruose; telefone sąrašas, tada detalės su „Grįžti į pokyčius“; skaitymo vaizdas ilgiems įrašams; sutraukta diagnostika |
