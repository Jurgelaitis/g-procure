...
| Failas | Paskirtis |
|---|---|
| `PP-teise/index.html` | Stebėsenos puslapis (tvarka nuo 2026-09-25): antraštės kortelė su sąžiningumo eilute ir išskleidžiama „Apie šaltinių patikrą“; trys klausimų kortelės su skaičiais (kas pasikeitė / kas įsigalios / ką peržiūrėti), po jomis „Trūksta duomenų“ ir „Archyvas“; paieška, tema ir susijęs įrankis vienoje eilutėje, kiti filtrai - „Daugiau filtrų“; neprivaloma „Mano pirkimas“ kortelė; sąrašas kairėje (~38 %) ir pasirinkto įrašo detalės dešinėje (A-G: antraštė ir statusai, pokyčio esmė, kam aktualu, nuo kada taikoma, ką peržiūrėti, pagrindimas ir šaltiniai su pažodine ištrauka, sutraukti rekvizitai); pasirinkimas adrese `#irasas=id`, filtrai adreso parametruose; telefone sąrašas, tada detalės su „Grįžti į pokyčius“; skaitymo vaizdas ilgiems įrašams; techninė diagnostika poraštėje |
