...
(function (global) {
  ...
  function stilius(doc) {
    ...
    var css = [
      ...
      ".gps__cta:hover,.gps__cta:focus-visible{background:var(--color-emerald-strong-hover,#006649);color:#fff}",
      ...
      ".gps__foot a{color:var(--color-emerald-strong,#007554);font-weight:800;text-decoration:none}",
