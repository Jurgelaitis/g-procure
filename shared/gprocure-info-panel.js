...
(function (global) {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      ".gpi-ic{width:34px;height:34px;border-radius:9px;flex-shrink:0;display:flex;align-items:center;justify-content:center;background:var(--color-green-5,#EFF9F1);color:var(--color-emerald-strong)}",
      ...
      ".gpi-btn:hover{border-color:var(--color-emerald,#00A072);color:var(--color-emerald-strong)}",
      ".gpi-btn.gpi-more{background:var(--color-emerald-strong);border-color:var(--color-emerald,#00A072);color:#fff}",
      ".gpi-btn.gpi-more:hover{background:var(--color-emerald-strong-hover);border-color:var(--color-emerald-120,#128A76);color:#fff}",
      ...
      ".gpi-num{width:24px;height:24px;border-radius:50%;flex-shrink:0;background:var(--color-emerald-strong);color:#fff;font-size:12px;font-weight:800;display:flex;align-items:center;justify-content:center;margin-top:1px}",
      ...
      ".gpi-h3{font-size:13px;font-weight:800;letter-spacing:.04em;text-transform:uppercase;color:var(--color-emerald-strong);margin:0 0 16px;display:flex;align-items:center;gap:8px}",
      ...
      ".gpi-flow-node{width:46px;height:46px;border-radius:50%;margin:0 auto 10px;background:var(--color-green-5,#EFF9F1);border:2px solid var(--color-emerald,#00A072);color:var(--color-emerald-strong);display:flex;align-items:center;justify-content:center;font-weight:800;font-size:16px;flex-shrink:0}",
      ...
      ".gpi-faq summary::after{content:'+';font-size:18px;font-weight:700;color:var(--color-emerald-strong);flex-shrink:0;transition:transform 180ms ease}",
