...
;(function (global) {
  ...
  var N = {
    ...
    met_nacsaugumas: { apie: "tikrinant atitiktį VPĮ 47 str. 9 d. - VPT formos atitikties deklaracija, laimėtojas teikia steigimo dokumentus, JAR išrašą ir kt. (ne senesnius kaip 3 mėn.)",
      bendra: { a: "MET", p: "8.8" } },
    met_fin_tikslas: { apie: "finansinio ir ekonominio pajėgumo vertinimo tikslas - įsitikinti, kad tiekėjas (ne jo patirtis) gebės padengti svarbiausias išlaidas, kol bus apmokėtos sąskaitos, ir įvykdyti reikalavimus, galinčius kilti iš netinkamo sutarties vykdymo",
      bendra: { a: "MET", p: "10" } },
    // 11.1-11.4 p. - į ką atsižvelgiama nustatant finansinius reikalavimus (pirkimo kontekstas AI ir taisyklėms)
    met_fin_trukme_verte: { apie: "sutarties trukmė ir vertė be PVM (ilgalaikei - didžiausia metinė vertė): kuo trumpesnis vykdymo laikotarpis ir didesnė vertė, tuo aukštesnį reikalavimą galima nustatyti",
      bendra: { a: "MET", p: "11.1" } },
    met_fin_apmokejimas: { apie: "apmokėjimo sąlygos (mokėjimų dažnumas, avansas): kuo dažnesnis ir greitesnis apmokėjimas, kuo didesnis avansas, tuo žemesnis finansinis reikalavimas",
      bendra: { a: "MET", p: "11.2" } },
    met_fin_priklausomybe: { apie: "ar nuo sutarties priklauso kitų sutarčių ar pirkimo vykdytojo veiklos vykdymas: kuo labiau priklauso, tuo aukštesnį reikalavimą galima nustatyti; ši aplinkybė nesiejama su skuba, ypač kai ją sukėlė pats pirkimo vykdytojas",
      bendra: { a: "MET", p: "11.3" } },
    met_fin_sektorius: { apie: "sektoriaus ypatumai ir rinkoje veikiančių tiekėjų esamas finansinis pajėgumas - skirtinguose sektoriuose ta pati rodiklio reikšmė gali reikšti skirtingą situaciją",
      bendra: { a: "MET", p: "11.4" } },
    met_dalims: { apie: "kai pirkimo objektas skaidomas į dalis, kvalifikacijos reikalavimai nustatomi kiekvienai daliai atskirai ir gali skirtis",
      bendra: { a: "MET", p: "7.2" } },
